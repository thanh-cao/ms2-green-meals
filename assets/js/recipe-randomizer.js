...
function recalculateNewMealPlanNutrients() {
...
function updateNewMealPlanNutrients() {
  ...
  writeNutrientsAbsoluteData(['calories', 'protein', 'fat', 'carbohydrates'], newMealPlanNutrients, 'mealPlanData');
}
...
function fetchMealPlan() {
  fetch(
    ...
    .then(results => {
      ...
      drawCaloricBreakdownChart(results.nutrients, 'mealPlanData'); // function from main.js
      writeNutrientsAbsoluteData(['calories', 'protein', 'fat', 'carbohydrates'], results.nutrients, 'mealPlanData'); // function from main.js
