...
function loadRecipeDetails() {
    ...
    writeNutrientsAbsoluteData(['calories', 'protein', 'fat', 'carbohydrates'], recipeData.nutrition.nutrients, 'mealData');
}
...
function displayEmptyRecipePage() {
    ...
    <div class="text-center container mt-3">
        ...
        <p>You haven't chosen any recipes to show yet. Please go back to <a href="recipe-randomizer.html">Recipe Randomizer page</a> to find something delicious for today</p>
    </div>        
    `);
}
